...
define(['js/tabiframe', 'js/eventemitter', 'js/keybindings'],
  ...
  if (window.OS == 'linux' || window.OS == 'windows') {
    RegisterKeyBindings(
      ...
      ['Alt',           'ArrowLeft',       () => TabIframeDeck.getSelected().goBack()],
      ['Alt',           'ArrowRight', () => TabIframeDeck.getSelected().goForward()],
  ...
  if (window.OS == 'osx') {
    RegisterKeyBindings(
      ...
      ['Cmd',       'ArrowLeft',  () => TabIframeDeck.getSelected().goBack()],
      ['Cmd',       'ArrowRight', () => TabIframeDeck.getSelected().goForward()],
